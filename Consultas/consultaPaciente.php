    ...
    <div class="container-fluid">
        <div class="card" style="background: rgba(0, 101, 191,0.6)">        
            <div class="card-body wizard-content">
                <h3 class="card-title" style="color: white">Paciente | Datos generales</h3>
                    ...
                    <div>
                        ...
                        <section>
                            <div class="row mb-12">
                                    ...
                                    ?>
                                <div class="col-lg-4">
                                    <label>Paciente<small class="text-muted"></small></label>
                                ...
                                <div class="col-lg-3">
                                    <label style="color: white">Fecha de Consulta<small class="text-muted"></small></label>
                                    <div class="input-group">
                                        <!--<input type="date" name="fecha" class="form-control mydatepicker" placeholder="Ingrese fecha de nacimiento">-->
