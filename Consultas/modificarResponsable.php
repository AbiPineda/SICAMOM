        ...
        <div class="container-fluid">
            <div class="card" style="background: rgba(0, 101, 191,0.3)">
                <div class="contenedor-modal" style="float: right; margin-left: 10px; margin-top: 15px;" >
                    ...
                    <h3 class="card-title">Modificar Responsable | Datos personales</h3>

                    <form action="modificarResponsable.php" method="post">
                        ...
                        <section>
                            ...
                            <div class="row mb-3">
                                <div class="col-lg-4">
                                    ...
                                    $sacar = mysqli_query($conexion, "SELECT*FROM t_responsable WHERE idresponsable='$modi'");
...
if (isset($_REQUEST['btnEnviar'])) {
    ...
    $sql = "UPDATE t_responsable SET res_cnombre='$nombre',res_capellidos='$apellido',res_ctelefono='$tel' WHERE idresponsable='$modi'";
    ...
    $usuario_insertado = $sentencia->execute();
        echo '<script>swal({
                ...
                function () {
                    location.href="consultaResponsable.php";
