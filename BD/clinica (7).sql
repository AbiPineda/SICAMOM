...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 16-11-2018 a las 03:41:46
...
INSERT INTO `t_consulta` (`idconsulta`, `fk_expediente`, `fk_enfermeria`, `con_fecha_atiende`, `con_diagnostico`, `con_ref_medica`, `con_cons_medica`, `con_receta`, `con_fecha_amenorrea`, `con_ctipo_consulta`) VALUES
(3, 1, 1, '2018-11-15', 'sdvddf', NULL, NULL, NULL, '0000-00-00', 'Seleccionar'),
(4, 1, 2, '2018-11-15', '', NULL, NULL, NULL, '0000-00-00', 'Seleccionar'),
(5, 1, 3, '2018-11-15', '', NULL, NULL, NULL, '0000-00-00', 'Seleccionar'),
(6, 1, 4, '2018-11-15', '', NULL, NULL, NULL, '0000-00-00', 'Seleccionar'),
(7, 1, 5, '2018-11-15', '', NULL, NULL, NULL, '0000-00-00', 'Seleccionar'),
(8, 1, 6, '2018-11-15', '', NULL, NULL, NULL, '0000-00-00', 'Seleccionar'),
(9, 1, 7, '2018-11-15', '', NULL, NULL, NULL, '0000-00-00', 'Seleccionar'),
(10, 1, 8, '2018-11-15', '', NULL, NULL, NULL, '0000-00-00', 'Seleccionar'),
(11, 1, 9, '2018-11-15', 'Nauseas y Vomitos en exceso', NULL, NULL, NULL, '2018-09-03', 'Control de Embarazo'),
(12, 1, 10, '2018-11-15', 'Dolor', NULL, NULL, NULL, '2018-11-04', 'Consulta General');
...
--
ALTER TABLE `t_enfermeria`
  MODIFY `id_enfermeria` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
ALTER TABLE `t_llegada`
  MODIFY `id_llegada` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
