	...
	<form method="post">
		...
		<?php
			if (isset($_POST['send'])){
				...
				$mail_username="k.reinaldo09@gmail.com";//Correo electronico saliente ejemplo: tucorreo@gmail.com
				$mail_userpassword="kevin1996";//Tu contraseña de gmail
				$mail_addAddress="kevin_rey09@hotmail.com";//correo electronico que recibira el mensaje
