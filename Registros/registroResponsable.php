            ...
            <div class="container-fluid">
                ...
                <div class="card" style="background: rgba(0, 101, 191,0.3)">
                    <div class="card-body wizard-content">
                        ...
                        <form id="example-form" action="/SICAMOM/php/registro_pac.php" class="m-t-40" method="POST">
                            <div>
                                ...
                                <input id="acceptTerms2" name="acceptTerms" type="checkbox">
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <!-- <div class="input-group">
                                    <input type="text" name="tipo" class="form-control" id="fnamep" placeholder="Ingrese tipo">  
                                    <div class="input-group-append">
                                        <span class="input-group-text"><i class="fas fa-user"></i></span>
                                    </div>
                                </div>  --> 
