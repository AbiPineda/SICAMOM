  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title" id="myModalLabel">Ayuda | Registro de Secretaria.</h4> 
...
style="width:700px; height:500px;" frameborder="0"></iframe>
    ...
    $tele = $_REQUEST['telefono'];
        ...
        mysqli_query($conexion, "INSERT INTO t_medico(med_cnombre,med_capellidos,direccion,telefono) VALUES('$nombre','$apellido','$direccion','$tele')");
        ...
        echo '<script>swal({
                ...
                function () {
                    location.href="registroSecretaria.php";
            });</script>';
