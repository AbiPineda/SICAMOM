...
if (isset($_REQUEST['nameEnviar'])) {
    ...
    $sql = "INSERT INTO t_responsable(idresponsable,res_cnombre,res_capellidos,res_cdui,res_ctelefono) VALUES('11','$nombre','$marca','$descripcion','$presentacion')";
        ...
        <div class="container-fluid" style="height: 671px;">
            ...
            <div class="card" style="background: rgba(0, 101, 191,0.3)">
                <div class="card-body wizard-content">
                    ...
                    <form id="example-form" action="inventario.php" method="POST" class="m-t-40">
                        <div>
